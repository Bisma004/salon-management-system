            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-caption">
                        <h2 class="page-title">Salon Service ans Staff</h2>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                           ...
                           <th>Available Staff (Female and Male) <i class="fa fa-user-circle"></i></th>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($ret)) {
                            ...
                            <tr>
                                ...
                                <td>
            <?php echo $row['AvailableStaff'] ? $row['AvailableStaff'] : 'No Staff Assigned'; ?>
        </td>
                            </tr>
                            <?php
                            $cnt = $cnt + 1;
