    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <h1 class="hero-title">BiaS SALON MANAGEMENT SYSTEM <i class="fa fa-scissors"></i></h1>
...
<section class="mission-vision">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="mission">
          ...
          <p>At our women’s salon management system, our mission is to deliver exceptional salon services tailored to women by using high-quality products, offering personalized care, and creating a relaxing and empowering environment. We are committed to exceeding our clients' expectations by staying up-to-date with the latest beauty trends and techniques, while also embracing an eco-friendly and sustainable approach that supports both personal well-being and environmental responsibility.
</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="vision">
          ...
          <p>Our vision is to become the leading salon management system specifically tailored for women’s salons, empowering salon owners to streamline their operations, enhance the beauty and wellness experience for their female clients, and boost overall profitability. We aim to achieve this vision by leveraging cutting-edge technology, fostering a culture of innovation and collaboration, and delivering exceptional customer service that supports the unique needs of women-focused beauty businesses.
</p>
        </div>
      </div>
    </div>
  ...
  <div class="what-we-do">
    <h2>What We Do</h2>
<ul>
  <li> <i class="fa fa-check-circle-o"></i> <b>Haircuts & Styling:</b> Our professional stylists specialize in women’s haircuts—from classic trims to trendy styles. We listen to your preferences and help you find a cut and style that enhances your natural beauty and suits your personality.</li>
  
  <li> <i class="fa fa-check-circle-o"></i><b>Hair Coloring:</b> Whether you want to refresh your natural shade, cover grays, or try a bold new color, our experts offer a range of coloring techniques including highlights, balayage, fashion colors, and more.</li>
  
  <li> <i class="fa fa-check-circle-o"></i><b>Facials & Skin Care:</b> Rejuvenate your skin with our customized facials designed for different skin types. We use premium products and advanced techniques to give your skin a healthy, glowing appearance.</li>
  
  <li> <i class="fa fa-check-circle-o"></i><b>Makeup Services:</b> Whether it's for a bridal event, party, or photo shoot, our makeup artists create stunning looks tailored to your features and occasion, using high-quality, skin-friendly products.</li>
  
  <li> <i class="fa fa-check-circle-o"></i><b>Body Care & Waxing:</b> Enjoy smooth, glowing skin with our professional body care treatments and hygienic waxing services. We ensure a comfortable and clean experience with long-lasting results.</li>
</ul>
  ...
  <section class="services">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service">
            <img src="images/hairs.jpg" alt="Haircut">
            <h3>Haircut, Color & Styling <i class="fa fa-scissors"></i></h3>
